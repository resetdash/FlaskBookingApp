...
############   patient_notification queue    #############
#delcare patient_noti queue
queue_name = 'patient_noti'
channel.queue_declare(queue=queue_name, durable=True)
    # 'durable' makes the queue survive broker restarts

#bind patient_noti queue
channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key='*.patient') 
